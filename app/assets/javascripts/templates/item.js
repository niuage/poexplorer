...
templates['item'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, buffer = "\n          <ul class=\"stats\">\n            ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.visible_stats), {"name":"each","hash":{},"fn":this.program(11, data),"inverse":this.noop,"data":data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n            ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.corrupted), {"name":"if","hash":{},"fn":this.program(13, data),"inverse":this.noop,"data":data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  return buffer + "\n          </ul>\n        ";
  ...
  stack1 = ((helper = helpers.requirements || (depth0 && depth0.requirements)),(typeof helper === functionType ? helper.call(depth0, {"name":"requirements","hash":{},"data":data}) : helper));
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</p>\n\n    <div class=\"row-fluid section small-section\">\n\n      <div class=\"span8\">\n        ";
  stack1 = helpers.unless.call(depth0, (depth0 && depth0.isSkill), {"name":"unless","hash":{},"fn":this.program(10, data),"inverse":this.noop,"data":data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n\n      </div>\n\n      <div class=\"span4\">\n        <ul class=\"props\">\n          ";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.properties), {"name":"each","hash":{},"fn":this.program(15, data),"inverse":this.noop,"data":data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
