...
G_MODIFIER_TYPES = {
  "+# to maximum Life" => [:one_hand_sword, :two_hand_axe, :body_armour, :boot, :glove, :helmet, :shield, :amulet, :belt, :quiver, :ring, :one_hand_axe, :wand],
  ...
  "Poisonous Hit" => [:claw],
  "10% additional Block Chance while Dual Wielding Claws" => [:claw, :two_hand_axe, :one_hand_sword],
  ...
  "#% reduced Attack Speed" => [:two_hand_mace, :glove, :amulet, :dagger],
  ...
  "+#% to all Elemental Resistances" => [:body_armour, :boot, :glove, :helmet, :shield, :amulet, :ring, :thrusting_one_hand_sword, :dagger, :belt, :two_hand_mace],
  ...
  # missing mods found
  "+# to Level of Socketed Vaal Gems"=>[:body_armour, :helmet, :glove, :boot, :shield],
 "+# to Level of Socketed Melee Gems"=>[:two_hand_mace, :thrusting_one_hand_sword],
 "+# to Level of Socketed Minion Gems"=>[:two_hand_mace, :shield],
 "Socketed Gems are Supported by level # Trap"=>[:staff, :boot],
 "Socketed Gems are supported by level # Blind"=>[:wand, :helmet],
 "+# to Level of Socketed Spell Gems"=>[:wand],
 "Regenerate # Life over # second for each Spell you Cast"=>[:wand],
 "Melee Critical Strikes have #% chance to cause Bleeding"=>[:dagger],
 "Melee Critical Strikes have #% chance to Poison the Enemy"=>[:dagger],
 "#% increased Stun Recovery"=> [:helmet, :boot, :belt, :amulet, :quiver, :shield, :glove],
 "+# to Level of Socketed Curse Gems"=>[:shield],
 "#% Chance to Cause Monster to Flee on Block"=>[:shield],
 "#% reduced Mana Regeneration Rate"=>[:ring, :helmet],
 "Temporal Chains has #% reduced Effect on You"=>[:ring],
 "#% reduced Chance to Block Attacks and Spells"=>[:belt],
 "You take #% reduced Extra Damage from Critical Strikes"=>[:belt],
 "#% increased Attack Speed while Ignited"=>[:ring],
 "#% increased Cast Speed while Ignited"=>[:ring],
 "+#% chance to be Ignited"=>[:ring],
 "#% of Cold Damage Converted to Fire Damage"=>[:ring],
 "Ignited Enemies you hit are destroyed on Kill"=>[:ring],
 "Your Flasks grant #% chance to Freeze during flask effect"=>[:belt],
 "#% chance to gain a Power Charge if you Knock an Enemy Back with Melee Damage"=>[:staff],
 "#% increased Melee Critical Strike Multiplier"=>[:helmet],
 "Increases and Reductions to Spell Damage also apply to Attacks"=>[:helmet],
 "Applies level # Punishment on Blocking a Melee Attack"=>[:shield],
 "Applies level # Temporal Chains on Blocking a Projectile Attack"=>[:shield],
 "Applies level # Elemental Weakness on Blocking a Spell"=>[:shield],
 "#% increased effect of Auras you Cast"=>[:staff],
 "Gain #% of Bow Physical Damage as Extra Damage of an Element"=>[:bow],
 "+# to Level of Socketed Gems"=> [:wand, :helmet, :sceptre, :body_armour, :boot, :glove, :ring, :shield],
 "Socketed Gems are Supported by level # Spell Echo"=>[:wand, :staff],
 "#% reduced Projectile Speed"=>[:quiver],
 "#% reduced Radius of Curses"=>[:quiver],
 "Curses on Slain Enemies are transferred to a nearby Enemy"=>[:quiver],
 "Socketed Gems are Supported by level # Spell Totem"=>[:body_armour],
 "#% increased Elemental Damage with Weapons during flask effect"=>[:belt],
 "#% reduced Global Critical Strike Multiplier"=>[:amulet],
 "#% increased Movement Speed when on Full Energy Shield"=>[:boot],
 "#% reduced Effect of Chill on You"=>[:ring],
 "#% increased Ignite Duration on You"=>[:ring],
 "#% increased Projectile Damage"=>[:quiver],
 "#% reduced number of Zombies allowed"=>[:sceptre],
 "+# to Zombie maximum Life"=>[:sceptre],
 "#% increased Zombie Resistances"=>[:sceptre],
 "#% increased Zombie Size"=>[:sceptre],
 "Zombies deal #% increased Physical Damage"=>[:sceptre],
 "Enemies killed by Zombies explode dealing Fire Damage"=>[:sceptre],
 "Socketed Gems are Supported by level # Increased Area of Effect"=> [:two_hand_axe, :two_hand_mace],
 "Socketed Gems are Supported by level # Added Fire Damage"=>[:sceptre],
 "Socketed Gems are Supported by level # Cold to Fire"=>[:sceptre],
 "Socketed Gems are Supported by level # Fire Penetration"=>[:sceptre],
 "Socketed Gems are supported by level # Chance to Flee"=>[:one_hand_axe],
 "+# to Level of Socketed Fire Gems"=>[:body_armour, :helmet, :staff],
 "Socketed Gems have #% chance to cause Enemies to Flee on Hit"=>[:claw],
 "You cannot be Shocked for # seconds after being Shocked"=>[:glove],
 "#% increased Damage against Ignited Enemies"=>[:boot],
 "Left ring slot: #% reduced Reflected Elemental Damage taken"=>[:ring],
 "Right ring slot: #% reduced Reflected Physical Damage taken"=>[:ring],
 "#% faster start of Energy Shield Recharge"=>[:body_armour, :quiver, :dagger],
 "#% increased Quantity of Items Dropped by Slain Frozen Enemies"=>[:bow],
 "#% increased Rarity of Items Dropped by Slain Shocked Enemies"=>[:bow],
 "Socketed Gems are Supported by level # Elemental Proliferation"=> [:body_armour, :sceptre],
 "Your Flasks grant #% chance to Ignite during flask effect"=>[:belt],
 "Attacks with this Weapon have #% increased Elemental Damage"=>[:wand],
 "Your Fire Damage can Shock but not Ignite"=>[:helmet],
 "Your Cold Damage can Ignite but not Freeze or Chill"=>[:helmet],
 "Your Lightning Damage can Freeze but not Shock"=>[:helmet],
 "Socketed Gems are Supported by level # Concentrated Effect"=>[:helmet],
 "#% slower start of Energy Shield Recharge"=>[:helmet],
 "Socketed Gems are supported by level # Cast on Death"=>[:helmet],
 "+# to Level of Socketed Cold Gems"=>[:helmet, :staff],
 "#% increased Effect of Shrine Buffs on you"=>[:helmet],
 "#% increased Duration of Shrine Effects on you"=>[:helmet],
 "+# to Level of Socketed Bow Gems"=>[:bow],
 "Creates Consecrated Ground on Critical Strike"=>[:ring],
 "#% increased Rarity of Items Dropped by Enemies killed with a Critical Strike"=> [:ring],
 "#% increased Chaos Damage"=>[:body_armour],
 "#% increased Life Leech rate"=>[:body_armour],
 "#% Global chance to Blind Enemies on hit"=>[:sceptre],
 "+# Mana gained on Kill per Level"=>[:sceptre],
 "+# Energy Shield gained on Kill per Level"=>[:sceptre],
 "Cannot be Blinded"=>[:sceptre],
 "Creates a Smoke Cloud on Rampage"=>[:glove],
 "Gain Unholy Might for # seconds on Rampage"=>[:glove],
 "Dispels Elemental Status Ailments on Rampage"=>[:glove],
 "Gain Immunity to Physical Damage for # seconds on Rampage"=>[:glove],
 "Projectile Damage increased by Arrow Pierce Chance"=>[:quiver],
 "+# to Level of Socketed Aura Gems"=>[:shield, :helmet],
 "Socketed Gems have Blood Magic"=>[:shield],
 "Socketed Gems have #% reduced Mana Reservation"=>[:shield],
 "Socketed Gems are Supported by level # Melee Physical Damage"=>[:helmet],
 "Socketed Gems are Supported by level # Faster Attacks"=>[:helmet],
 "Socketed Melee Gems have #% increased Area of Effect Radius"=> [:two_hand_sword],
 "Socketed Red Gems get #% Physical Damage as Extra Fire Damage"=> [:two_hand_sword],
 "+# to Level of Socketed Strength Gems"=>[:two_hand_axe],
 "Socketed Gems are Supported by level # Added Chaos Damage"=>[:body_armour],
 "+# to Level of Socketed Movement Gems"=>[:body_armour],
 "Nearby allies Recover #% of your maximum Life when you Die"=>[:shield],
 "#% of Elemental Damage taken as Chaos Damage"=>[:body_armour],
 "Light Radius is based on Energy Shield instead of Life"=>[:body_armour],
 "#% increased Attack Damage per # Evasion Rating"=>[:one_hand_sword],
 "Socketed Gems have #% reduced Mana Cost"=>[:helmet],
 "#% reduced Energy Shield Recharge Rate"=>[:quiver],
 "Socketed Gems are supported by level # Fork"=>[:bow],
 "Socketed Gems are supported by level # Melee Splash"=>[:dagger],
 "Leech applies instantly on Critical Strikes at #% effectiveness"=>[:glove],
 "Skills Chain +# times"=>[:one_hand_mace],
 "#% increased Lightning Damage with Weapons"=>[:one_hand_mace],
 "+# Strength Requirement"=>[:one_hand_mace],
 "+# Intelligence Requirement"=>[:one_hand_mace],
 "#% chance to Cast Socketed Lightning Spells on Hit"=>[:one_hand_mace],
 "Socketed Gems are Supported by level # Added Lightning Damage"=>[:glove],
 "#% increased Damage over Time"=>[:dagger],
 "On Killing a Poisoned Enemy, nearby Enemies are Poisoned"=>[:dagger],
 "On Killing a Poisoned Enemy, nearby Allies Regenerate Life"=>[:dagger],
 "Adds #-# Chaos Damage to Spells"=>[:wand],
 "You gain Onslaught for # seconds on using a Vaal Skill"=>[:glove],
 "Ignited Enemies Burn #% faster"=>[:one_hand_sword],
 "You can only deal Damage with this Weapon and Ignite"=>[:one_hand_sword],
 "Unwavering Stance"=>[:boot],
 "#% increased Character Size"=>[:ring],
 "Your Flasks grant #% reduced Enemy Stun Threshold during flask effect"=> [:belt],
 "#% chance to gain a Power Charge on Throwing a Trap"=>[:shield],
 "Grants level # Bear Trap Skill"=>[:shield],
 "Curse Enemies with level # Vulnerability on Block"=>[:staff],
 "Minions have #% reduced maximum Life"=>[:body_armour],
 "Minions gain Unholy Might for # seconds on Kill"=>[:body_armour],
 "+# to Level of Socketed Lightning Gems"=>[:staff],
 "#% increased Strength Requirement"=>[:staff],
 "Damage Penetrates #% Lightning Resistance"=>[:staff],
 "+# to Level of Active Socketed Skill Gems"=>[:two_hand_sword],
 "+# Life gained on Kill per Level"=>[:two_hand_sword],
 "#% increased Elemental Damage per Level"=>[:two_hand_sword],
 "#% increased Chaos Damage per Level"=>[:two_hand_sword],
 "+# to Level of Socketed Support Gems"=>[:two_hand_axe],
 "#% reduced Endurance Charge Duration"=>[:amulet],
 "#% reduced Power Charge Duration"=>[:amulet],
 "Gain an Endurance Charge when a Power Charge expires or is consumed"=> [:amulet],
 "+# to Level of Socketed Elemental Gems"=>[:glove],
 "#% increased Movement Speed per # Evasion Rating"=>[:body_armour],
 "-# Physical Damage taken when hit by Animals"=>[:body_armour],
 "#% increased Global Critical Strike Chance per Level"=>[:two_hand_axe],
 "Gain Flask Charges when you deal a Critical Strike"=>[:two_hand_axe],
 "#% of Damage Leeched as Life on Critical Strike"=>[:two_hand_axe],
 "#% increased Damage taken per Frenzy Charge"=>[:one_hand_sword],
 "#% increased Lightning Damage per Frenzy Charge"=>[:one_hand_sword],
 "+# Life gained on Kill per Frenzy Charge"=>[:one_hand_sword],
 "#% chance to create a Smoke Cloud when Hit"=>[:quiver],
 "#% increased Damage against Blinded Enemies"=>[:quiver],
 "Socketed Skill Gems get a #% Mana Multiplier"=>[:body_armour],
 "#% increased Shock Duration on You"=>[:belt],
 "Shocks you cause are reflected back to you"=>[:belt],
 "#% increased Damage while Shocked"=>[:belt],
 "#% increased Movement Speed while Shocked"=>[:belt],
 "#% of Elemental Damage Leeched as Life"=>[:sceptre],
 "Socketed Gems are supported by level # Cast On Crit"=>[:glove],
 "Recover #% of your Maximum Life on Rampage"=>[:glove],
 "Gain # Souls for Vaal Skills on Rampage"=>[:glove],
 "#% increased Armour, Evasion and Energy Shield"=>[:body_armour],
 "Socketed Gems are Supported by level # Iron Will"=>[:sceptre],
 "#% increased Damage per # Strength when in Main Hand"=>[:sceptre],
 "#% increased Armour per # Strength when in Off Hand"=>[:sceptre],
 "Your Critical Strikes do not deal increased Damage"=>[:two_hand_mace],
 "You gain Onslaught for # seconds on Critical Strike"=>[:two_hand_mace],
 "+#% to Fire Resistance when Socketed with a Red Gem"=>[:ring],
 "+#% to Cold Resistance when Socketed with a Green Gem"=>[:ring],
 "+#% to Lightning Resistance when Socketed with a Blue Gem"=>[:ring],
 "All Sockets are White"=>[:ring],
 "Socketed Gems have Elemental Equilibrium"=>[:ring],
 "Socketed Gems have #% reduced Elemental Equilibrium effect"=>[:ring],
 "Grants level # Assassin's Mark Skill"=>[:glove],
 "Socketed Gems are supported by level # Life Leech"=>[:claw],
 "Adds #-# Fire Damage against Ignited Enemies"=>[:sceptre]
}
